//=============================================================================
//
// file :		MultiLocalAttribute.h
//
// description :	Include file for the MultiLocalAttribute class.
...
#ifndef _MULTILOCALATTRIBUTE_H
#define _MULTILOCALATTRIBUTE_H
...
//@{
/**
 * Create a new MultiLocalAttribute object.
 *
 ...
 */
	MultiLocalAttribute(std::string &dev_name,DeviceClass *dev_class,DeviceImpl *dev);
//@}
...
//@{
/**
 * The MultiLocalAttribute desctructor.
 */
	~MultiLocalAttribute();
//@}
 ...
 * MultiLocalAttribute object) of an attribute with a given name. The name equality
 * is case independant
 *
 * @param attr_name The attribute name
 ...
 * The list of Attrs.
 *
 * These are device leel attributes so they are not in the Class list
 */
...
/// @privatesection
	...
	void add_attribute(std::string &,DeviceClass *,long, Attr *);
...
private:
    ...
    std::unique_ptr<MultiLocalAttributeExt>           ext;           // Class extension
};
